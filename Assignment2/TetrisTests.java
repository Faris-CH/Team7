...
public class TetrisTests {
    ...
    @Test
    void testMakeFastRotationsMultiple() {
        TetrisPiece piece = new TetrisPiece(TetrisPiece.L2_STR);
        piece = TetrisPiece.makeFastRotations(piece);
        String[] target = {"0 0 0 1 1 0 2 0", "0 0 0 1 0 2 1 2", "0 1 1 1 2 1 2 0", "0 0 1 0 1 1 1 2"};
        int counter = 0;
        while(counter < 4){
            TetrisPiece np = new TetrisPiece(target[counter]);
            piece = piece.fastRotation();
    ...
    void testEqualsFalse() {
        ...
        TetrisPiece pieceA = new TetrisPiece("0 0  1 1  1 2  0 1");
        TetrisPiece pieceB = new TetrisPiece("1 0  1 1  1 2  0 1");
        assertFalse(pieceB.equals(pieceA), "Error when testing piece equality");
        assertFalse(pieceA.equals(pieceB), "Error when testing piece equality");

    }

    @Test
    void testEqualsSubset() {

        TetrisPiece pieceA = new TetrisPiece("1 0  1 1  1 2  0 1");
        TetrisPiece pieceB = new TetrisPiece("1 0  1 1  1 2  0 1  2 1");
        assertFalse(pieceB.equals(pieceA), "Error when testing piece equality");
        assertFalse(pieceA.equals(pieceB), "Error when testing piece equality");
    ...
    @Test
    void testEqualsDiffOrder() {

        TetrisPiece pieceA = new TetrisPiece("1 0  1 1  1 2  0 1");
        TetrisPiece pieceB = new TetrisPiece("0 1  1 2  1 1  1 0");
        assertTrue(pieceB.equals(pieceA), "Error when testing piece equality");
        assertTrue(pieceA.equals(pieceB), "Error when testing piece equality");
