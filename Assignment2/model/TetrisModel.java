...
public class TetrisModel implements Serializable {
     ...
     * Start new game
     */
    public void startGame() throws IOException { //start game
        random = new Random();
        addNewPiece();
        gameOn = true;
        score = 0;
     ...
     */
    public void addNewPiece() throws IOException {
        count++;
        score++;
     ...
     */
    public void modelTick(MoveType verb) throws IOException {
     ...
     */
    private void executeMove(MoveType verb) throws IOException {
